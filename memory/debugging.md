...
Keys from deleted features (`cc-reset-v1`, `cc-cache-v4`, `cc-ratelimit`, `cc-ring-diag`,
`cc-debug`, `cc-hide-topbar`) may still be sitting in localStorage; nothing reads them anymore.
